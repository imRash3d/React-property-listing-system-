...
import { getListingTypes, getCities } from "../services/propertyService";
class Filter extends Component {
  ...
  render() {
    const listing_types = [
      { id: 0, name: "Listing Type" },
      ...this.state.listing_types
    ];
    const { onSelectType, onlistFiltered, onSortChange } = this.props;
    return (
